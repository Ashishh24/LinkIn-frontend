    ...
    return (
      <div>
        ...
        <h1 className="font-bold text-2xl flex justify-center my-5">
          You haven't sent request to anyone. Connect with someone.
        </h1>
        <div className="flex justify-center items-center">
          <button
            ...
            className="my-5 flex justify-center items-center w-[50%] px-5 py-2 rounded-full border cursor-pointer hover:bg-blue-500 hover:text-white">
            Connect
          </button>
        </div>
      </div>
